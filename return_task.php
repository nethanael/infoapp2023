<?php
    ...
    $whereClause="infoapp_tasks.dept_code='$dept_code' AND infoapp_tasks.month ='$month' AND infoapp_tasks.year ='$year' AND task_report = 1";
			...
			<div class = "table-responsive">
                ...
                <table class="table table-sm table-striped table-hover">
                    <thead class="thead-dark">
                        <tr>
                            <th class="my_td" colspan="5">Actividades para devolver:</th>
                        </tr>
                        <tr>
                            <td colspan="5"><small>Hacer cl&iacute;c en el c&oacute;digo de la actividad, revisar los avances y devolver a pendiente si no est&aacute de acuerdo con los entregado.</small></td>
                        </tr>
                    </thead>
                    <tr>
                                    ...
                                    foreach ($line as $col_name => $col_value)
                                        {
                                             if ($col_name== 'task_code'){
                                                 echo "<td class='my_td'><a class='btn btn-primary' href=return_task_2.php?data=",$col_value,">$col_value</a></td>";
                                             }else{
