<?php
    ...
    $fields="infoapp_tasks.task_code, infoapp_tasks.task_title, infoapp_tasks.task_description, infoapp_users.last_name, infoapp_departments.dept_name, infoapp_task_type.task_type_title, infoapp_tasks.req_date";
    ...
    $whereClause="infoapp_tasks.dept_code='$dept_code' AND infoapp_tasks.task_report=0";
			...
			<div class = "table-responsive my_scrollable_div">
                ...
                <table class="table table-sm table-striped table-hover">
                    <thead class="thead-dark">
                        <tr>
                            <th class="my_td" colspan="10">Actividades Pendientes del Departamento:</th>
                        </tr>
                        <tr>
                            <td colspan="10"><p class="text-center font-weight-light">Antes de generar el informe mensual esta tabla debe estar vac&iacutea</p></td>
                        </tr>
                    </thead>
                    <tr>
                        ...
                        <th><small>Responsable Principal:</small></th>
                        <th><small>Departamento:</small></th>
                        <th><small>Tipo de Actividad:</small></th>
                        <th><small>Fecha L&iacutemite:</small></th>
                        <th><small>Estado de Avances:</small></th>
                    </tr>
