	...
	<?php include 'includes/navBar.php'; ?>
        ...
        <div class = "row justify-content-center my_row">
			<div class = "col-6 my_col">
				<!-- (row_!Centro!) -->
                <form name="" method="post" action="scripts/general_month_report.php"> 
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>Importante:</td>
                            <td>      
                                Para generar el informe el sistema tomar&aacute; todas las actividades que se 
                                marcaron como "Listas" para informe.
                            </td>
                        </tr>
                        <tr>
                            <td>Mes:</td>
